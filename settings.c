...
PROGMEM const settings_t defaults = {
    ...
    .parking.flags.rehome_on_park_stop = DEFAULT_REHOME_ON_PARK_STOP,
...
PROGMEM static const setting_detail_t setting_detail[] = {
     ...
     { Setting_ParkingEnable, Group_SafetyDoor, "Parking cycle", NULL, Format_XBitfield, "Enable,Deactivate upon init,Enable parking override control,Require re-home after park stop", NULL, NULL, Setting_IsExtendedFn, set_parking_enable, get_int, NULL },
